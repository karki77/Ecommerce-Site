...
import { Row, Col, ListGroup, Button, Image,Form, ListGroupItem} from 'react-bootstrap';
import { useSelector, useDispatch } from 'react-redux';
import { addToCart, removeItem, emptyCart } from '../slices/cartSlice';
...
const CartPage = () => {
  ...
  return cartItems.length == 0 ? (<Message>The cart is empty. <Link to="/">Go Back</Link></Message>) : (<Row>
    <Col md={8}>
