...
import {Row, Col, ListGroup, Image, ListGroupItem, Button, Form, FormGroup} from 'react-bootstrap'
import Rating from '../components/Rating'
import axios from 'axios';
import {useParams, useNavigate} from "react-router-dom";
import {useDispatch} from 'react-redux';
import { addToCart } from '../slices/cartSlice';
import {useAddReviewMutation, useCheckReviewStatusQuery, useGetProductByIdQuery} from '../slices/productSlice';
...
const Productpage = () => {
  ...
  const dispatch = useDispatch();
    ...
    const {data: reviewStatus, isLoading: reviewStatusLoading, error: reviewStatusError} = useCheckReviewStatusQuery(id);
    console.log(product);
     ...
     <>
      ...
      <Row className='my-3'>
         <Col md={6} className='reviews'>
            ...
            {
              reviewStatusLoading ? <h1>Loading...</h1> :  reviewStatusError ? <Message>{reviewStatusError.data.error}</Message> :
            ...
            <Form onSubmit={addReviewHandler}>
               <FormGroup controlId = "rating" className='my-3'>
                ...
                <FormGroup controlId='comment' className='my-3'>
                   ...
                   <Form.Control 
                   as ="textarea"
                    rows={3} placeholder='Enter comment...'
                    onChange={e => setComment(e.target.value)}/>
              </FormGroup>
                <Button varient = "dark" type='submit'>Add</Button>
            </Form>
                </>
